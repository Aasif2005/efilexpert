  ...
  return (
    <div className="scroll-container">
      <div className="min-h-screen relative overflow-hidden overscroll-none touch-pan-y">
        ...
        <header className="relative z-20 w-full pt-8 md:pt-12 lg:pt-16">
          <div className="container mx-auto px-4 py-4 lg:py-6">
            <div className="hidden md:flex items-center justify-center space-x-4 lg:space-x-6 transition-all duration-500 ease-in-out transform hover:scale-105">
              <div className="flex-shrink-0 group">
                <Image
                  ...
                  width={80}
                  height={53}
                  className="w-16 h-auto lg:w-20 xl:w-24 transition-all duration-500 ease-in-out drop-shadow-lg group-hover:scale-110 group-hover:drop-shadow-2xl group-hover:brightness-110"
                  priority
                />
              </div>
              <div>
                <h1 className="text-2xl lg:text-3xl xl:text-4xl font-bold text-white tracking-tight transition-all duration-500 ease-in-out hover:text-blue-200 hover:scale-105 drop-shadow-lg">
                  EfileXpert
                </h1>
              </div>
            </div>

            {/* Mobile Layout: Centered logo with text below */}
            <div className="md:hidden flex flex-col items-center space-y-3 transition-all duration-500 ease-in-out transform hover:scale-105">
              <div className="group">
                <Image
                  src="/logo.png"
                  alt="E File Xpert Logo"
                  width={60}
                  height={40}
                  className="w-12 h-auto sm:w-14 transition-all duration-500 ease-in-out drop-shadow-lg group-hover:scale-110 group-hover:drop-shadow-2xl group-hover:brightness-110"
                  priority
                />
              </div>
              <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight transition-all duration-500 ease-in-out hover:text-blue-200 hover:scale-105 drop-shadow-lg text-center">
                EfileXpert
              </h1>
            </div>
          </div>
        ...
        {/* Main Content */}
        <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-8 pt-8 md:pt-4">
          <div className="text-center max-w-4xl mx-auto space-y-8 animate-fade-in">
            <div className="space-y-6">
              <h2 className="text-2xl md:text-4xl font-bold text-white tracking-tight animate-slide-up drop-shadow-2xl">
                ...
                <div className="space-y-5 text-left">
                  ...
                  <div className="grid md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-3 transition-all duration-300 hover:transform hover:scale-[1.02] p-4 rounded-lg hover:bg-blue-900/20 hover:shadow-lg">
                      ...
                      <p className="text-blue-100 leading-relaxed text-sm">
                        Built to work seamlessly in both India and the UAE, helping businesses handle VAT registration
                        and compliance challenges. Direct integration with official government portals ensures reliable,
